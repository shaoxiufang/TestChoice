...
通过本次实验，比较系统的完成了学生选课系统，考试前一周的复习对本次实验帮助很大，更加熟练的掌握构造方法，自定义方法，文件的读取，GUI页面的设计，
对我今后的学习和思维方式的提高有了很大的帮助，但同时，本次实验仍有许多不足，退课的功能仍存在问题，还有当用户注册完成后进入登录页面时，注册页面仍
不能关闭，以后我将潜心学习，不断的将功能完善。
